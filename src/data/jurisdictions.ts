...
Drawbacks: The country historically had high crime, though there have been major improvements – crime rates have plummeted with the 2023 homicide rate falling to 2.4 per 100k, the lowest in the Americas after Canada. Infrastructure is developing. Education and healthcare are below first-world standards.`,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1622495546520-e2c0a5da3bdd?w=1200', alt: 'El Salvador beach sunset', creditName: 'Jeison Higuita', creditUrl: 'https://unsplash.com/@jeisonhiguita', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1585262892880-cc83e7b7e0eb?w=1200', alt: 'El Salvador coastline', creditName: 'Ana Paula Alcantara', creditUrl: 'https://unsplash.com/@anapalcantara', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1608374326217-705c8d6e2f3f?w=1200', alt: 'San Salvador city', creditName: 'Alex Fernandez', creditUrl: 'https://unsplash.com/@_alexfernandez', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1591801102824-c8acd90c81b4?w=1200', alt: 'El Salvador volcano', creditName: 'Cristofer Jeschke', creditUrl: 'https://unsplash.com/@cristofer', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1600019258978-e1d9c6f04a5d?w=1200', alt: 'Tropical beach El Salvador', creditName: 'Jeremy Bishop', creditUrl: 'https://unsplash.com/@jeremybishop', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1527631746610-bca00a040d60?w=1200', alt: 'El Salvador surfing', creditName: 'Austin Neill', creditUrl: 'https://unsplash.com/@austin_neill', sourceName: 'Unsplash' },
    ],
  },
...
Drawbacks: The concerns here are more political – with China's influence, some expatriates feel less secure about long-term freedoms. Cost of living is extremely high, among the highest in the world. Housing is notoriously expensive and cramped.`,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1536599018102-9f803c979e15?w=1200', alt: 'Hong Kong skyline', creditName: 'Simon Zhu', creditUrl: 'https://unsplash.com/@smnzhu', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1531259683007-016a7b628fc3?w=1200', alt: 'Hong Kong harbor night', creditName: 'Ruslan Bardash', creditUrl: 'https://unsplash.com/@ruslanbar', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1518599807935-37015b9cefcb?w=1200', alt: 'Hong Kong neon streets', creditName: 'Steven Wei', creditUrl: 'https://unsplash.com/@stevenwei', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1506461883276-594a12b11cf3?w=1200', alt: 'Victoria Peak view', creditName: 'Lok Yiu Cheung', creditUrl: 'https://unsplash.com/@yiucheung', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1547981609-4b6bfe67ca0b?w=1200', alt: 'Hong Kong street market', creditName: 'Jimmy Chan', creditUrl: 'https://unsplash.com/@jchan', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1517030330234-94c4fb948ebc?w=1200', alt: 'Hong Kong tram', creditName: 'Manson Yim', creditUrl: 'https://unsplash.com/@mansonyms', sourceName: 'Unsplash' },
    ],
  },
...
Drawbacks: Bitcoin regulations remain somewhat unclear after the partial veto. Not as Bitcoin-focused as El Salvador. Tropical climate with humidity.`,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1564056420281-73ffd5b7eaa3?w=1200', alt: 'Panama City skyline', creditName: 'Matthew T Rader', creditUrl: 'https://unsplash.com/@matthew_t_rader', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1559827291-72ee739d0d9a?w=1200', alt: 'Panama Canal', creditName: 'Robert V Ruggiero', creditUrl: 'https://unsplash.com/@robert2301', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1537434284823-d87c7f7c3a7e?w=1200', alt: 'Casco Viejo Panama', creditName: 'Matthias Mullie', creditUrl: 'https://unsplash.com/@matthiasmullie', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1565877369-86cb4e0d3bbb?w=1200', alt: 'Panama beaches', creditName: 'Luis Alfaro', creditUrl: 'https://unsplash.com/@luisalfaro', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=1200', alt: 'Panama cityscape night', creditName: 'David Becker', creditUrl: 'https://unsplash.com/@beckerworks', sourceName: 'Unsplash' },
      { url: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=1200', alt: 'San Blas Islands Panama', creditName: 'Jeremy Bishop', creditUrl: 'https://unsplash.com/@jeremybishop', sourceName: 'Unsplash' },
    ],
  },
];
